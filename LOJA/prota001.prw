...
Static Function ConsProd(oSay)
    ...
    Define MsDialog oDlgPrinc Title cCadastro From aCoors[1], aCoors[2] To aCoors[3]/1.2, aCoors[4] Pixel
        ...
        oBrowseCons:= FWBrowse():New()
            ...
            oBrowseCons:SetDoubleClick( {|| nOpcDlg:= 1 , oDlgPrinc:End() } )
        ...
        @ 38, 30 MSGET oGetPesq4 VAR cProdut of oPanelPara SIZE 150, 00 VALID .T. PIXEL F3 "SB1" HasButton PICTURE "@!"
                                                            
        @ 60, 00 Button "&Filtrar" of oPanelPara Size 30,12 Pixel Action (FwMsgRun(NIL, {|o| FiltraDados(o,cDescPr,cFabric,cProdut,cAliasTB1,oBrowseCons,oBmp) }, cCadastro, "Buscando Produtos..."), oBrowseCons:SetFocus())
        @ 60, 45 Button "&Limpar"  of oPanelPara Size 30,12 Pixel Action (LimpaCampos( @cDescPr,@cFabric,@cProdut,cAliasTB1,oBrowseCons ), oGetPesq2:SetFocus())
    ...
    Activate MsDialog oDlgPrinc Center On Init oGetPesq2:SetFocus()
